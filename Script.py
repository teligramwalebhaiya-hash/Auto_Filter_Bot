class script(object):
    START_TXT = """<b><u>✨ Rᴀᴅʜᴇ Rᴀᴅʜᴇ ✨</u></b>

<b>ʜᴇʏ {}, {}</b>

<b>🤖 ɪ ᴀᴍ <a href=https://t.me/{}>{}</a>, ᴛʜᴇ ʙᴇsᴛ ᴘᴏᴡᴇʀғᴜʟ & ᴀᴅᴠᴀɴᴄᴇᴅ ᴍᴏᴠɪᴇ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ ɪɴ ᴡʜᴏʟᴇ ᴛᴇʟᴇɢʀᴀᴍ.\n✨ ᴊᴜsᴛ sᴇɴᴅ ᴍᴇ ʏᴏᴜʀ ᴍᴏᴠɪᴇ's ɴᴀᴍᴇ ᴡɪᴛʜ ᴄᴏʀʀᴇᴄᴛ sᴘᴇʟʟɪɴɢ ᴀɴᴅ sᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ ✨</b>
"""


    GSTART_TXT = """<b>✨ Rᴀᴅʜᴇ Rᴀᴅʜᴇ ✨</b>

<b>ʜᴇʏ {},</b>

<b>🤖 ɪ ᴀᴍ <a href=https://t.me/{}>{}</a>, ᴛʜᴇ ʙᴇsᴛ ᴘᴏᴡᴇʀғᴜʟ & ᴀᴅᴠᴀɴᴄᴇᴅ ᴍᴏᴠɪᴇ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ ɪɴ ᴡʜᴏʟᴇ ᴛᴇʟᴇɢʀᴀᴍ. ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇᴅ ᴀʟʟ ʟᴀᴛᴇꜱᴛ ᴍᴏᴠɪᴇꜱ ᴏʀ ꜱᴇʀɪᴇꜱ.\n✨ ᴊᴜsᴛ sᴇɴᴅ ᴍᴇ ʏᴏᴜʀ ᴍᴏᴠɪᴇ's ɴᴀᴍᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ ᴀɴᴅ sᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ ✨.</b>"""
...
4) SᴡᴀPɴᴏNɪL ɪs ʙᴜsʏ ᴛᴏ ʜɪs ᴘᴇʀsᴏɴᴀʟ ʟɪғᴇ
...
➤ 📷 Qʀ ᴄᴏᴅᴇ → <a href='{}'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ (Aᴠᴀɪʟᴀʙʟᴇ Sᴏᴏɴ)</a>  
➤ 💸 ᴜᴘɪ ɪᴅ → <code>{}</code>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/graduate_movies">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/graduate_movies">[ Gʀᴀᴅᴜᴀᴛᴇ Mᴏᴠɪᴇs ]</a></b>"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/Yours_Swapno'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
Sᴏʀʀʏ !! This Is Nᴏᴛ An Open-Source Project. Dᴇᴠᴇʟᴏᴘᴇᴅ Bʏ SᴡᴀᴘɴᴏNɪL.\n
<a href=http://t.me/graduate_movies>᯽𝑆𝑂𝑈𝑅𝐶𝐸 𝐼𝑁𝐹𝑂 𝐻𝐸𝑅𝐸᯽</a>\n """
