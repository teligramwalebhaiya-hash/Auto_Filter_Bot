    ...
    try:
        ...
        if pm_search:
            ...
            await message.reply_text(
                text=(
                    f"<b>🙋 ʜᴇʏ {user} 😍 ,\n\n"
                    "Sᴏʀʀʏ! Yᴏᴜ Cᴀɴɴ'ᴛ Rᴇǫᴜᴇsᴛ Hᴇʀᴇ. Pʟᴇᴀsᴇ Jᴏɪɴ Oᴜʀ Sᴇᴀʀᴄʜ Gʀᴏᴜᴘ Bʏ Cʟɪᴄᴋɪɴɢ ᴏɴ Tʜᴇ 𝒔𝒆𝒂𝒓𝒄  𝑹𝑬𝑸𝑼𝑬𝑺𝑻 𝑯𝑬𝑹𝑬 Bᴜᴛᴛᴏɴ Gɪᴠᴇɴ Bᴇʟᴏᴡ Aɴᴅ Sᴇᴀʀᴄʜ Yᴏᴜʀ Fᴀᴠᴏʀɪᴛᴇ Mᴏᴠɪᴇ Tʜᴇʀᴇ 👇\n\n"
                    "<blockquote>"
                    "Oɴʟʏ Pʀᴇᴍɪᴍᴜᴍ Mᴇᴍʙᴇʀs Aʀᴇ Aʟʟᴏᴡᴇᴅ ᴛᴏ Sᴇᴀʀᴄʜ Hᴇʀᴇ.. "
                    "Cᴏɴᴛᴀᴄᴛ Mʏ Oᴡɴᴇʀ ɪғ Yᴏᴜ Wᴀɴᴛ ᴛᴏ Usᴇ Mᴇ Hᴇʀᴇ. Oᴛʜᴇʀᴡɪsʜ Rᴇǫᴜᴇsᴛ Gʀᴏᴜᴘ ɪs Aʟᴡᴀʏs Oᴘᴇɴᴅ Fʀᴇᴇʟʏ Fᴏʀ Yᴏᴜ 🤞"
                    "</blockquote></b>"
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            dreamx_stream = "{URL}watch/{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
        ...
        buttons = [[
            InlineKeyboardButton('Oᴡɴᴇʀ ☏︎', url='https://t.me/Yours_Swapno'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
