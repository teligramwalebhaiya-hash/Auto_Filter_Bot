...
# ============================
SESSION = environ.get('SESSION', 'GraduateMovi3sProvider')   # Session name for the bot
API_ID = int(environ.get('API_ID', '34941698')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '7b2940bab3ebb175e9ceef78846c090b')  # API Hash from my.telegram.org
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002524198335'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002666880524'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003384592518')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003349815268')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Gm_Support_chat')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002612579654")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002743050170")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sahebchoudhury067:CElXPsYmo4XnJDQO@cluster0.crhcvk3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Graduate_Movies') # Collection name (default: dreamcinezone_files)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Graduate_Request_Pro') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/yours_swapno') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/graduate_movies') # Update channel link for the bot

# ============================
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7859995064').split()]
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{script.Thaks For Requesting Us}")   # Custom caption for files
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', -1002900228022))  # Index Request Channel ID (make sure bot is admin)
