...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://teligramwalebhaiya_db_user:bohaSAeafY8E2yEQ@cluster0.wlngqsd.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
